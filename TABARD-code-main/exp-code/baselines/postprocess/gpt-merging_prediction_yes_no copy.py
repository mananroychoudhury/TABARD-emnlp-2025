...
if __name__ == "__main__":
    ...
    for fold in tqdm(folder,desc="main_folder_processing") :
        for i in List:
            chunked_folder_path = f"(dataset_name ie.(FetaQA ... ))/gpt-prediction-chunks/predictions-{fold}/{i}/"
            merged_output_path = f"(dataset_name ie.(FetaQA ... ))/gpt-prediction/predictions-{fold}/{i}/"
