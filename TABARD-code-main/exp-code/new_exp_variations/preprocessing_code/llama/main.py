...
# Step 3: produce JSONL payloads for llama from (step 2) output
...
def main():
    ...
    for fold in FOLDS:
        ...
        anomaly_jsonl_out= f"....New-expirements/Batchfiles/llama/{fold}/l4-cot"

        print("─▶ STEP 3: Generating .jsonl payloads for llama…")
